...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/chapter5/fig5_1}
    \caption{CES demand curves for good~1 across values of~$\varepsilon$. Higher substitutability flattens the demand curve.}
    \label{fig:ces-demand-curves}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/chapter5/fig5_2}
    \caption{Expenditure share of good~1 as a function of the relative price~$p_1/p_2$. When $\varepsilon > 1$, the share falls with $p_1$ (substitution dominates); when $\varepsilon < 1$, the share rises (income effect dominates). At $\varepsilon = 1$ (Cobb-Douglas), the share equals $\omega_1$ regardless of price.}
    \label{fig:expenditure-share-vs-price}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/chapter5/fig5_3}
    \caption{Expenditure share of good~1 as a function of~$\varepsilon$ at fixed prices. When good~1 is expensive ($p_1 = 2 > p_2$), higher substitutability shifts spending away from it; when it is cheap ($p_1 = 0.5 < p_2$), the opposite occurs. At $\varepsilon = 1$, the share equals the preference weight~$\omega_1$.}
    \label{fig:expenditure-share-vs-sigma}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/chapter5/fig5_6}
    \caption{Cross-price elasticity $\eta_{12} = (\varepsilon - 1)w_2$ as a function of~$\varepsilon$ for different expenditure shares~$w_2$. Goods are gross substitutes when $\varepsilon > 1$ and gross complements when $\varepsilon < 1$.}
    \label{fig:cross-price-elasticity}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/chapter5/fig5_4}
        \caption{Exact vs.\ myopic own-price elasticity}
        \label{fig:exact-myopic-own-price}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/chapter5/fig5_5}
        \caption{Slutsky decomposition ($\varepsilon = 2$)}
        \label{fig:slutsky-decomposition}
    \end{subfigure}
    \caption{Own-price elasticity decomposition. Left: the exact elasticity $\eta_{ii} = -\varepsilon(1-w_i) - w_i$ deviates from the myopic $-\varepsilon$ as $w_1$ grows. Right: the substitution and wealth components of the Slutsky decomposition.}
    \label{fig:own-price-panel}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/chapter5/fig5_7}
    \caption{Elasticity along the demand curve ($\varepsilon = 2$). As $p_1$ rises, the expenditure share $w_1$ changes, causing the exact elasticity to deviate from the constant myopic value~$-\varepsilon$.}
    \label{fig:elasticity-along-demand-curve}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/chapter5/fig5_8}
    \caption{Demand for three goods as a function of the power parameter~$\rho$. As $\rho$ increases (toward perfect substitutes), demand shifts toward the cheapest good.}
    \label{fig:demand-vs-rho}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/chapter5/fig5_9}
        \caption{Myopic vs.\ exact rho-elasticity}
        \label{fig:myopic-exact-rho}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figures/chapter5/fig5_10}
        \caption{Price-index effect: $\log(\bar{p}_w / \Pstar)$}
        \label{fig:price-index-effect}
    \end{subfigure}
    \caption{Rho-elasticity decomposition. Left: the myopic semi-elasticity $\varepsilon^2\log(\Pstar/p_1)$ versus the exact $\varepsilon^2\log(\bar{p}_w/p_1)$ as $p_1$ varies. Right: the price-index correction $\log(\bar{p}_w/\Pstar)$ as a function of~$\varepsilon$; it vanishes at the Cobb-Douglas limit $\varepsilon = 1$.}
    \label{fig:rho-elasticity-panel}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/chapter5/fig5_11}
    \caption{Share reallocation as $\rho$ varies for $n = 5$ goods with dispersed prices. As $\rho$ increases (toward substitutes), expenditure concentrates on the cheapest goods. At $\rho = 0$ (Cobb-Douglas), shares equal the preference weights.}
    \label{fig:share-reallocation}
\end{figure}
